  ...
  const onSubmitHandle = async (e) => {
    ...
    try {
      const response = await axios
        .post(`${base_url}/authentification/reset/${resetToken}`, {
          newPassword,
        })
        .then((res) => {
          console.log(res);
                  ...
                  <div className="row g-0">
                    ...
                    <div className="col-lg-6 order-1">
                      <div className="p-4 p-sm-7">
                        ...
                        <p className="mb-sm-0">Enter the new password.</p>
                        {/* Form START */}
                        <form
                        ...
                        >
                          ...
                          <div className="mb-3 position-relative">
                            ...
                            {formErrors.newPassword && <div className="text-danger mt-1"><i className="bi bi-exclamation-triangle"></i> {formErrors.newPassword}</div>}
                          </div>
                          {/* Button */}
